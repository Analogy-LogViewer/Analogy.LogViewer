...
namespace Analogy.UserControls
{
    public partial class FolderTreeViewUC : XtraUserControl
    {
        ...
        {
            InitializeComponent();
            _fileSystemUcFileSystem1.SetListing(true, false);
            _fileSystemUcFileSystem1.FolderChanged += (s, e) => FolderChanged?.Invoke(this, new FolderSelectionEventArgs(e.SelectedFolderPath));
        }
        ...
        private async Task PopulateFolders(string folderText, IAnalogyOfflineDataProvider dataProvider)
        {
            ...
            {
                _fileSystemUcFileSystem1.SetPath(folderText, dataProvider);
        ...
        public void SetFolder(string folder, IAnalogyOfflineDataProvider dataProvider)
        {
            ...
            _fileSystemUcFileSystem1.SetPath(folder, dataProvider);
            SetRecentFolderList();
        }
        ...
        private void SetRecentFolderList()
        {
            ...
            foreach (var folder in ServicesProvider.Instance.GetService<IAnalogyUserSettings>().GetRecentFolders(DataProvider.Id))
            {
