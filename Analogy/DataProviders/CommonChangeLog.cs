...
namespace Analogy.DataProviders
{
    public static class CommonChangeLog
    {
        ...
        {
            yield return new AnalogyChangeLog("Detailed message window is ignoring inplace filtering (in the grid control) and shows incorrect number of messages (issue #58)", AnalogChangeLogType.Defect, "Lior Banai", new DateTime(2019, 11, 19));
