...
namespace Analogy.DataProviders
{
    public static class CommonChangeLog
    {
        ...
        {
            yield return new AnalogyChangeLog("Consolidate all data providers (per factory) under the ribbon UI (issue #63)", AnalogChangeLogType.Defect, "Lior Banai", new DateTime(2019, 12, 09));
