...
namespace Analogy
{
    ...
    {
        public static Lazy<IAnalogyLogger> _instance = new Lazy<IAnalogyLogger>(()=>new AnalogyLogger());
        public static IAnalogyLogger Intance => _instance.Value;
        ...
        private string ProcessName { get; } = CurrentProcess.ProcessName;
