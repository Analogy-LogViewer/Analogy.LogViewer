...
namespace Analogy.Updater
{
    internal partial class DownloadUpdateDialog : XtraForm
    {
        ...
        private void UnzipZipFileIntoTempFolder(string zipPath, string extractPath)
        {
            ...
            else if (_currentFrameworkAttribute.FrameworkName.EndsWith("6.0"))
            {
            ...
            else if (_currentFrameworkAttribute.FrameworkName.EndsWith("8.0"))
            {
                version = "net8.0-windows";
            }
            else if (_currentFrameworkAttribute.FrameworkName.EndsWith("9.0"))
            {
                version = "net9.0-windows";
            }
            else if (_currentFrameworkAttribute.FrameworkName.EndsWith("10.0"))
            {
