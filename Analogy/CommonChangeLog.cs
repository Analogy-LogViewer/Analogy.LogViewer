...
namespace Analogy.DataProviders
{
    public static class CommonChangeLog
    {
        ...
        {
            yield return new AnalogyChangeLog("Upgrade DevExpress Version to 19.1.8 (Latest supported with current license)", AnalogChangeLogType.Defect, "Lior Banai", new DateTime(2019, 12, 27)); yield return new AnalogyChangeLog("Default user setting are invalid for some properties (issue #76)", AnalogChangeLogType.Improvement, "Lior Banai", new DateTime(2020, 01, 11));
