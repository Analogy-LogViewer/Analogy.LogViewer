...
namespace Analogy
{
    public static class CommonChangeLog
    {
        public static IEnumerable<AnalogyChangeLog> GetChangeLog()
        {
            ...
            {
                new ("V5.1.0.- Refacor file association to use data provider and not data factory #1843",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2023,09,15),"5.1.0.0"),
                ...
                new ("V4.14.0 - Improving docking UX and other improvements #1723",AnalogChangeLogType.Bug,"pybride",new DateTime(2023, 05, 08), ""),
                new ("V4.14.0 - Refactor GitHub client usage (use OctoKit.net Nuget) #1713",AnalogChangeLogType.Bug,"pybride",new DateTime(2023, 05, 08), ""),
                ...
                new AnalogyChangeLog("V4.10.2 - [Recent Files] Recent files button does not call InitializeDataProvider(ILogger logger) method #1571",AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2022, 12, 24), ""),
                new AnalogyChangeLog("V4.10.2 - [Recent files] duplicated entries are added #1570",AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2022, 12, 24), ""),
                new AnalogyChangeLog("V4.10.2 - [Grid Table] Additional dynamics columns are editable and should be read only #1572",AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2022, 12, 24), ""),
                ...
                new AnalogyChangeLog("V4.10.0 - [Real Time providers] closing the application does not call StopReceiving unless the tab is closed manually #1537",AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2022, 11, 10), ""),
                new AnalogyChangeLog("V4.10.0 - [Improvements] lazy init providers #1538",AnalogChangeLogType.Improvement, "Lior Banai", new DateTime(2022, 11, 10), ""),
                new AnalogyChangeLog("V4.10.0 - Revert Replace Newtonsoft.Json with System.Text.Json #1497",AnalogChangeLogType.Improvement, "Lior Banai", new DateTime(2022, 10, 22), ""),
                new AnalogyChangeLog("V4.10.0 - Replace Newtonsoft.Json with System.Text.Json #1497",AnalogChangeLogType.Improvement, "Lior Banai", new DateTime(2022, 10, 22), ""),
                ...
                new AnalogyChangeLog("V4.9.0 - [SQL filter] Allow export/copy the final query of the filters #1396",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2022,08,26), ""),
                new AnalogyChangeLog("V4.9.0 - [DevExpress] Upgrade to V21.2.9 #1382",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2022,07,21), ""),
                new AnalogyChangeLog("V4.8.7 - Disable PowerToys data provider default on #1378",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2022,07,16), ""),
                new AnalogyChangeLog("V4.8.7 - [DevExpress] Upgrade to V21.2.8 #1322",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2022,07,16), ""),
                new AnalogyChangeLog("V4.8.7 - Warn users that net3.1 end of support will reached on December 8, 2022 #1348",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2022,06,22), ""),
                new AnalogyChangeLog("V4.8.7 - Warn users that net5 end of support has reached #1347",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2022,06,22), ""),
                ...
                new AnalogyChangeLog("V4.7.5 - Add Show json data of Selected text in message details #1089",AnalogChangeLogType.Improvement,"Lior Banai",new DateTime(2021,07,31), ""),
            ...
            new AnalogyChangeLog("Added: take screenshot of the messages control", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 07, 09), ""),
            new AnalogyChangeLog("Added: more information to log data source.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 07, 09), ""),
            new AnalogyChangeLog("Added: Real time event viewer: add Philips specific logs to list.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 08, 19), ""),
            new AnalogyChangeLog("Change: Splunk export datetime normalization..", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 07, 03), ""),
            new AnalogyChangeLog("Change: Splunk export improvements..", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 06, 19), ""),
            new AnalogyChangeLog("Added: New feature: fix corrupted files..", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 06, 15), ""),
            new AnalogyChangeLog("Added: Export to xlsx format as default (instead of xls).", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 06, 14), ""),
            new AnalogyChangeLog("Added: New timeline Vizualizer feature.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 06, 13), ""),
            new AnalogyChangeLog("Added: Splunk support for different zip folder structure.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 06, 02), ""),
            new AnalogyChangeLog("Changes: Harmonized look and feel of UI.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 06, 01), ""),
            new AnalogyChangeLog("Changes: Splunk improvements and fixes of old defects in the old splunk converter app.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05,31), ""),
            new AnalogyChangeLog("Fixed: Performance improvement for paging mechanism.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 28), ""),
            new AnalogyChangeLog("Fixes: CT logs related improvements and fixes", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 08, 19), ""),
            new AnalogyChangeLog("Changes: Event viewer improvements.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 25), ""),
            new AnalogyChangeLog("Fixed: some messages' parsing is partial.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 20), ""),
            new AnalogyChangeLog("Added: Paging mechanism for better performance.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 18), ""),
            new AnalogyChangeLog("Added: font size  settings.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 18), ""),
            new AnalogyChangeLog("Fixed: Go to message sometimes missed the currently selected message", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 16), ""),
            new AnalogyChangeLog("Added: Export to Excel/CSV and added undock current view", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 15), ""),
            new AnalogyChangeLog("Added: Paging mechanism (Page size is user defined)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 15), ""),
            new AnalogyChangeLog("Fixed: Under some conditions not all text of the message was being displayed", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 15), ""),
            new AnalogyChangeLog("Added: Auto scroll to last message.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 12), ""),
            new AnalogyChangeLog("Added: Support for Windows Event viewer log files.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 12), ""),
            new AnalogyChangeLog("Added: Log Comparer (under tools).", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 12), ""),
            new AnalogyChangeLog("Added: Support for PHILIPS CT BU real time read (SQL Database)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 10), ""),
            new AnalogyChangeLog("Added: Additional User setting options", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 09), ""),
            new AnalogyChangeLog("Added: Support for MIRADA XD log file formats", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 08), ""),
            new AnalogyChangeLog("Added: Support for PHILIPS CT BU log file formats", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 07), ""),
            new AnalogyChangeLog("Added: Copy bookmarks messages to clipboard.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 06), ""),
            new AnalogyChangeLog("Added: Copy all messages to clipboard.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 05), ""),
            new AnalogyChangeLog("Added: Splunk bugrep extractor cancellation support", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 04), ""),
            new AnalogyChangeLog("Fixed: Column Layout setting file location was not set to app assembly location", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 03), ""),
            new AnalogyChangeLog("Added: Analogy Splunk Bugrep extractor (V1)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 05, 02), ""),
            new AnalogyChangeLog("Fixed: NullReferenceException under some condition (real time mode)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 28), ""),
            new AnalogyChangeLog("Added: Ability to cancel loading of files.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 27), ""),
            new AnalogyChangeLog("Added: User setting - auto startup of extensions", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 21), ""),
            new AnalogyChangeLog("Fixed: History of messages and other fixes.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 18), ""),
            new AnalogyChangeLog("Added: Analogy Simple View (User setting).", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 13), ""),
            new AnalogyChangeLog("Added: Persistant bookmark between runs.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 13), ""),
            new AnalogyChangeLog("Added: indication of when file has empty messages or corrupted.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 07), ""),
            new AnalogyChangeLog("Added: Columns layout can now be save (right click on any massage).", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 06), ""),
            new AnalogyChangeLog("Changes: more user feadback for some operations", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 04, 05), ""),
            new AnalogyChangeLog("Added: Feature: new data sources (client/sever/folders)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 31), ""),
            new AnalogyChangeLog("Changes: Reduced memory print of Analogy.EXE", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 31), ""),
            new AnalogyChangeLog("Added: support for themes (dark mode)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 30), ""),
            new AnalogyChangeLog("Added: User Statistics", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 30), ""),
            new AnalogyChangeLog("Added: Most Recent used files", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 29), ""),
            new AnalogyChangeLog("Added: Message Clear History", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 29), ""),
            new AnalogyChangeLog("Added: User settings", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 28), ""),
            new AnalogyChangeLog("Added: Grouping by substrings", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 27), ""),
            new AnalogyChangeLog("Added: Support for NLOG files", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 15), ""),
            new AnalogyChangeLog("Added: Support for JSON files", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 03, 15), ""),
            new AnalogyChangeLog("Added: Support for SQL reserved words in filter queries", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 02, 22), ""),
            new AnalogyChangeLog("Fixed: High CPU Usage when connection is broken to log service", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 02, 18), ""),
            new AnalogyChangeLog("Added: Extensions framework and UI redesign - User Control extension", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 02, 15), ""),
            new AnalogyChangeLog("Added: Extensions framework and UI redesign - In Place extension", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 02, 11), ""),
            new AnalogyChangeLog("Added: Extensions framework and UI redesign", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 02, 09), ""),
            new AnalogyChangeLog("Added: Highlight lines + exclude module/Source", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 01, 25), ""),
            new AnalogyChangeLog("Change: double click on messages now open the messages instead of adding it to the bookmarks.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2019, 01, 03), ""),
            new AnalogyChangeLog("Fixes: bug fixes and improvements", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 31), ""),
            new AnalogyChangeLog("Added: New feature: Bookmark of messages.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 22), ""),
            new AnalogyChangeLog("change: Better response time of loading data.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 20), ""),
            new AnalogyChangeLog("Added: New feature: Statistics Analyzer.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 20), ""),
            new AnalogyChangeLog("Change: switching to 64 bit version.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 18), ""),
            new AnalogyChangeLog("Change: Sending logs over WCF is now locked", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 17), ""),
            new AnalogyChangeLog("Add: Additional Filtering Options", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 17), ""),
            new AnalogyChangeLog("Bug Fix: Pause logs does nothing.", AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2018, 12, 15), ""),
            new AnalogyChangeLog("Added: Exclude Source and modules (use , or | to seperate items)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 14), ""),
            new AnalogyChangeLog("Performance: faster filtering or results", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 14), ""),
            new AnalogyChangeLog("Fixed: More complex SQL queries are allowed.", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 14), ""),
            new AnalogyChangeLog("Added: Folders Tree view", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 13), ""),
            new AnalogyChangeLog("Added: Ctrl + A shortcut for file listing", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 13), ""),
            new AnalogyChangeLog("Fixed: some small UI bugs.", AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2018, 12, 13), ""),
            new AnalogyChangeLog("Added: adding loading progress bar to indicate files are loading (log file takes time)", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 12), ""),
            new AnalogyChangeLog("Change: switching to non blocking UI operations", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 12), ""),
            new AnalogyChangeLog("Change: UI changes", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 09), ""),
            new AnalogyChangeLog("Fixed: WCF related fixes and changes", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 07), ""),
            new AnalogyChangeLog("Fixes: General bugs", AnalogChangeLogType.None, "Lior Banai", new DateTime(2018, 12, 01), ""),
