...
namespace Analogy.DataProviders
{
    public static class CommonChangeLog
    {
        public static IEnumerable<AnalogyChangeLog> GetChangeLog()
        {
            ...
            yield return new AnalogyChangeLog("NullReferenceException during row painting (Philips ICAP data provider). (Issue #85)", AnalogChangeLogType.Improvement, "Lior Banai", new DateTime(2019, 12, 27)); yield return new AnalogyChangeLog("Persist Analogy internal log to file (issue #83)", AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2020, 01, 31));
            yield return new AnalogyChangeLog("Core 3.0 - Extension App config lookup is invalid (issue #80)", AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2019, 12, 27)); yield return new AnalogyChangeLog("Default user setting are invalid for some properties (issue #76)", AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2020, 01, 03));
            ...
            yield return new AnalogyChangeLog("Auto complete user setting is not working (issue #78)", AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2019, 12, 27)); yield return new AnalogyChangeLog("Default user setting are invalid for some properties (issue #76)", AnalogChangeLogType.Bug, "Lior Banai", new DateTime(2020, 01, 03));
